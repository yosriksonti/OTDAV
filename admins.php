                                ...
                                <table id="bootstrap-data-table" class="table table-striped table-bordered">
                                    ...
                                    <tbody>
                                         <?php
                                                     ...
                                                     $query1= mysqli_query($mysqli,"SELECT * FROM `ad_users` ");
                                        ...
                                        <tr>
                                            <td class="serial"><?php echo $i ;?></td>
                                                    ...
                                                    <td>  <span class="name"><?php echo $row['username']; ?></span> </td>
                                                    <td> <span class="product"><?php echo $row['email']; ?></span> </td>
                                                    <td><span class="name"><?php echo $row['active'];  ?></span></td>
                                                    <td><span class="name"><?php echo $row['blocked'];  ?></span></td>
