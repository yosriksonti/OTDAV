...
if($_SERVER['REQUEST_METHOD'] == 'POST')
{
   ...
   $result = mysqli_query($mysqli, "INSERT INTO breuve(Titre,Date) VALUES ('$Title','$Date')");
    ...
    <?php require_once "include.php"; ?>
        ...
        <div class="content">
            ...
            <div class="animated fadeIn">
                <!-- Widgets  -->
               <div class="card">
                        <div class="card-header">Ajout de breuvé</div>
                        <div class="card-body card-block">
                            <form action="" method="post" class="" enctype="multipart/form-data">
                                <small >(*) : Requis</small>
                                <div class="form-group">
                                    <div class="input-group">
                                        <input type="text" id="namefr" name="Title" placeholder="Titre *" class="form-control" <?php echo'required';?>>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        <input type="date" id="bd" name="Date" placeholder="Date" class="form-control" <?php echo'required';?>>
