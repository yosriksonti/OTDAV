            ...
            <div class="animated fadeIn">
               ...
               <div class="card">
                        <div class="card-body card-block">
                            <form action="list_depot.php?ID=<?php echo $cin; ?>" method="" class="" enctype="multipart/form-data">
                                ...
                                <form action="update_depot.php?ID=<?php echo $ID; ?>" method="" class="" enctype="multipart/form-data">
