...
<body>
                                ...
                                <table id="bootstrap-data-table" class="table table-striped table-bordered">
                                    ...
                                    <tbody>
                                         <?php
                                                     ...
                                                     $query1= mysqli_query($mysqli,"SELECT * FROM `breuve` ");
  ...
  <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
    <a class="dropdown-item" href="contribution.php?id=<?php echo $row['ID']; ?>">Contributions</a>
    <a class="dropdown-item" href="addcntr.php?id=<?php echo $row['ID']; ?>">Ajouter Une Contribution</a>
    <a class="dropdown-item" href="updatebr.php?id=<?php echo $row['ID']; ?>">Modifier</a>
    <a class="dropdown-item" href="deletebr.php?id=<?php echo $row['ID']; ?>">Supprimer</a>
  </div>
</div></td>
                                        </tr>
                                        <?php $i++; }?>
