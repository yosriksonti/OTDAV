...
if($_SERVER['REQUEST_METHOD'] == 'POST')
{
    ...
    $result = mysqli_query($mysqli, "INSERT INTO adherants(Nom_PrenomFR,Nom_PrenomAR,Date_de_naissance,CIN,Cotisation,Telephone,Adresse_postale,RIB,Email) VALUES('$namefr','$namear','$bd','$cin','$cotisdate','$phonenumber','$adress','$RIB','$email')");
        if(!$result){
                ...
                <ul class="nav navbar-nav">
                    ...
                    <li class="menu-item-has-children dropdown">
                        ...
                        <ul class="sub-menu children">                            
                            <li><i class="fa fa-id-badge"></i><a href="<?php echo"users.php";?>">Liste d'adhérants</a></li>
                            <li><i class="fa fa-file-word-o"></i><a href="<?php echo"addus.php";?>">Ajoutez un adhérant</a></li>
                            
                        </ul>
                    </li>
                    <li class="menu-title">Breuvés</li><!-- /.menu-title -->
                    <li class="menu-item-has-children dropdown">
                        
                        <ul class="sub-menu children">                            
                            <li><i class="fa fa-id-badge"></i><a href="<?php echo"breuves.php";?>">Liste des breuvés</a></li>
                            <li><i class="fa fa-file-word-o"></i><a href="<?php echo"addbr.php";?>">Ajoutez une breuvé</a></li>
                    ...
                    <li class="menu-item-has-children dropdown">
                        ...
                        <ul class="sub-menu children">
                            <li><i class="fa fa-table"></i><a href="admins.php">Liste d'administrateurs</a></li>
                            <li><i class="fa fa-table"></i><a href="">Ajouter</a></li>
                        </ul>
