...
if($_SERVER['REQUEST_METHOD'] == 'POST')
{
        ...
        $Pourcentage = mysqli_real_escape_string($mysqli, $_POST['Pourcentege']);
    $result = mysqli_query($mysqli, "UPDATE br_contribution SET Role='$Role', Pourcentage='$Pourcentage' WHERE MAT_AD= '$mat' AND ID_BR='$id'");
        ...
        <div class="content">
            ...
            <div class="animated fadeIn">
               ...
               <div class="card">
                ...
                $mat=$_GET['mat'];
                $id=$_GET['id'];
                 $query1= mysqli_query($mysqli,"SELECT * FROM `br_contribution` where MAT_AD= '$mat' AND ID_BR='$id'");
                            ...
                            <form action="" method="post" class="" enctype="multipart/form-data">
                                ...
                                <div class="form-group">
                                    <div class="input-group">
                                        <input type="text" id="Role" name="Role" placeholder="Role" class="form-control" <?php echo'required';?> value="<?php echo $row['Role'];?>" >
                                        <div class="input-group-addon"><i class="fa fa-user"></i></div>
                                    </div>
                                </div>
                                 <div class="form-group">
                                    <div class="input-group">
                                        <input type="float" id="Pourcentege" name="Pourcentege" placeholder="Pourcentege *" class="form-control" <?php echo'required';?> value="<?php echo $row['Pourcentage'];}?>">
