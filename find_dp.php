            ...
            <div class="animated fadeIn">
               ...
               <div class="card">
                        <div class="card-body card-block">
                            <form action="find_depot.php?ID=<?php echo $cin; ?>" method="" class="" enctype="multipart/form-data">
                          ...
                          <table class="table table-inbox table-hover">
                            ...
                            echo '
                              <tr class="unread">
                                  ...
                                  <td class="view-message  text-right"><a href="depot.php?ID='.$row['numero'].'"   title="Visualiser"    class="btn btn-compose" style="padding:2px; width: 75px; ">
                              Visualiser
                          </a></td>
                              </tr>';?>
                          </tbody>
