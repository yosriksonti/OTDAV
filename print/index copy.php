<?php
	...
	$id = $_GET['id'];
	$result = mysqli_query($mysqli, "SELECT * FROM adherents WHERE id=$id");
		...
		<script  charset="utf-8" type="text/javascript">
			JsBarcode("#barcode", "Dep 3 7089",{
			  ...
			  function printPDF(ff,kk,ll,ss,ui,uk) {
				   ...
				   pdf.addImage(imaaage3, 'JPEG', 5, 5, 24, 27);
				   pdf.addImage(imaaage4, 'PNG', 5, 27, 30, 10);
				   pdf.text(50, 31, "<?php echo $ID;?>");
				   ...
				   pdf.addImage(ctx9.canvas.toDataURL(), 'JPEG', 40, 33.3,40, 20);
				   pdf.addImage(ctx10.canvas.toDataURL(), 'JPEG', 40, 42.7,40, 20);
				   pdf.text(50, 61.2, "<?php echo $CIN;?>");
				   var idp=("<?php echo $ID;?>");
				   printed(idp);
				   ...
				   //verso
					 ...
					 const pdf2 = new jsPDF('l', 'mm', [120 , 70]);
					   ...
					   pdf2.addImage(imaaage, 'PNG', 42, 17, 38, 26);
					   ...
					   pdf2.addImage(barcode, 'JPEG', 60, 53,40, 7);
					   //pdf.save("otdav");
					   pdf2.autoPrint();
