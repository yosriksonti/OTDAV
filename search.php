            ...
            <div class="animated fadeIn">
               ...
               <div class="card">
                        <div class="card-body card-block">
                            <form action="list_quittance.php" method="POST" class="" enctype="multipart/form-data">
                        
                                <div class="card-header">Quittance</div>
                                <div class="form-group">
                                    <span>From:</span>
                                    <div class="input-group">
                                        <input type="date" id="cin" name="From" placeholder="From *" class="form-control" <?php echo'required';?> value="">
                                ...
                                <div class="form-group">
                                    <span>To:</span>
                                    <div class="input-group">
                                        <input type="date" id="cin" name="To" placeholder="To *" class="form-control" <?php echo'required';?> value="">
                                        <div class="input-group-addon"><i class="fa fa-user"></i></div>
                                    </div>
                                </div>
