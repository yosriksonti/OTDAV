                    ...
                    <div class="col-md-12">
                        <div class="card">
                            <div class="card-header">
                                <strong class="card-title">Les Demandes de validation</strong>
                            </div>
                            <div class="card-body">
                          ...
                          <table class="table table-inbox table-hover">
                            <tbody>
                            <?php 
                            $result = mysqli_query($mysqli, "SELECT * FROM depot WHERE etat='4'");
                            ...
                            echo '
                              <tr class="unread">
                                  ...
                                  <td class="view-message  text-right"><a href="renew_validate2_1.php?ID='.$row['numero'].'"   title="Validate"    class="btn btn-compose" style="padding:2px; width: 75px; ">
                              Validate
                          </a></td>
                              </tr>';?>
                          </tbody>
