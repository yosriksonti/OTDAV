...
if($_SERVER['REQUEST_METHOD'] == 'POST')
{
    ...
    $result = mysqli_query($mysqli, "UPDATE breuve SET Titre='$Titre', Date='$Date' WHERE ID= '$id'");
        ...
        <div class="content">
            ...
            <div class="animated fadeIn">
               ...
               <div class="card">
                <?php
                $mat=$_GET['id'];
                 $query1= mysqli_query($mysqli,"SELECT * FROM `breuve` where ID='$mat'");
                            ...
                            <form action="" method="post" class="" enctype="multipart/form-data">
                                ...
                                <div class="form-group">
                                    <div class="input-group">
                                        <input type="text" id="namefr" name="Titre" placeholder="Titre *" class="form-control" <?php echo'required';?> value="<?php echo $row['Titre']; ?>">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        <input type="date" id="bd" name="Date" placeholder="Date" class="form-control" <?php echo'required';?> value="<?php echo $row['Date'];} ?>">
