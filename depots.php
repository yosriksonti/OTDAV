...
<body>
 ...
 <?php $result = mysqli_query($mysqli,"select * from depot where etat=0"); ?>
        <!-- /#header -->
        <!-- Content -->
        <div class="content">
            <!-- Animated -->
                          ...
                          <table class="table table-inbox table-hover">
                            ...
                            echo '
                              <tr class="unread">
                                  ...
                                  <td class="view-message  text-right"><a href="addqt.php?ID='.$row['numero'].'"   title="Validate"    class="btn btn-compose" style="padding:2px; width: 75px; ">
                              Validate
                          </a></td>
                              </tr>';?>
                          </tbody>
