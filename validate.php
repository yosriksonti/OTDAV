                    ...
                    <div class="col-md-12">
                        <div class="card">
                          ...
                          <table class="table table-inbox table-hover">
                            <tbody>
                            <?php 
                            $result = mysqli_query($mysqli, "SELECT * FROM depot WHERE etat='1'");
                            ...
                            echo '
                              <tr class="unread">
                                  ...
                                  <td class="view-message  text-right"><a href="validate_step1.php?ID='.$row['numero'].'"   title="Validate"    class="btn btn-compose" style="padding:2px; width: 75px; ">
                              Validate
                          </a></td>
                              </tr>';?>
                          </tbody>
