                ...
                <div class="orders">
                    <div class="row">
                        <div class="col-xl-12">
                            <div class="card">
                                <div class="card-body">
<h4 class="box-title">Depots
</h4>
                                <form action="snd_mail_all.php" method="POST">
                                		<input type="hidden" name="auth" value="<?php echo "1"; ?>" >
                                		<button type="submit" style="float: right" class="btn btn-secondary btn-sm">Contacter Tous</button>
                                	</form>
</div>
                                <div class="card-body--">
...
<td> <span class="product"><?php echo $row['montant']." DT"; ?> </br> <?php echo $row['montant_lettres']; ?></span> </td>
                                                    ...
                                                    <td>
                                                    <form action="snd_mail.php" method="POST">
                                                        <input type="hidden" name="email" value="<?php echo $r['email'] ;?>">
                                                        <button id="submit" type="submit" class="btn btn-secondary btn-sm">Contacter</button>
                                                    </form>
                                                </tr>
                                            <?php $i++; }}}?>
                                            </tbody>
